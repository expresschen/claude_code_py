...
class AppState:
    ...
    # Agent view navigation (for viewing teammate status and messages)
    viewing_agent_task_id: Optional[str] = None  # Task ID of currently viewed agent
    view_selection_mode: str = "none"            # "none", "selecting-agent", "viewing-agent"
    selected_agent_index: int = -1               # -1 = leader, 0+ = teammate index
    expanded_view: str = "none"                  # "none", "teammates"
