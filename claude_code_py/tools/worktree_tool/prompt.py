"""Enter Worktree Tool prompt."""


def get_enter_worktree_tool_prompt() -> str:
    """Get the prompt for EnterWorktreeTool.
...
- The user asks to fix a bug or work on a feature — use normal git workflow unless
  they specifically mention worktrees
