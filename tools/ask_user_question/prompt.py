...
def get_ask_user_question_prompt() -> str:
    """Get AskUserQuestion tool prompt."""
    return f"""Use this tool when you need to ask the user questions during execution. This allows you to:
